...
{
    return sprintf(
        '<div class="alert alert-%s"><span class="closebtn" onclick="this.parentElement.style.display=\'none\'";">&times;</span> %s</div>',
        $flash_message['type'],
...
function limit($string, $word_limit, $suffix = '...')
{
    $words = explode(" ", $string); //Pecah jadi array
